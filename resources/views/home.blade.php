...
.floating-icon.green { background: #dcfce7; color: #16a34a; }
.floating-icon.blue { background: #dbeafe; color: #2563eb; }
.floating-icon.orange { background: #ffedd5; color: #ea580c; }
...
.feature-card:nth-child(2)::before { background: linear-gradient(90deg, #f093fb 0%, #f5576c 100%); }
.feature-card:nth-child(3)::before { background: linear-gradient(90deg, #4facfe 0%, #00f2fe 100%); }
.feature-card:nth-child(4)::before { background: linear-gradient(90deg, #fa709a 0%, #fee140 100%); }
.feature-card:nth-child(5)::before { background: linear-gradient(90deg, #a8edea 0%, #fed6e3 100%); }
.feature-card:nth-child(6)::before { background: linear-gradient(90deg, #d299c2 0%, #fef9d7 100%); }
